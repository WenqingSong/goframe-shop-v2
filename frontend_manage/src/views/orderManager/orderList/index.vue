        ...
        >
          <template slot-scope="scope">
            <el-tag v-if="scope.row.pay_type === 0" type="info" effect="dark"
              >未支付</el-tag
            >
            <el-tag v-if="scope.row.pay_type === 1" type="success" effect="dark"
              >微信</el-tag
            >
            <el-tag v-if="scope.row.pay_type === 2" type="primary" effect="dark"
              >支付宝</el-tag
            >
            <el-tag v-if="scope.row.pay_type === 3" type="danger" effect="dark"
              >云闪付</el-tag
            >
          </template>
        </el-table-column>
